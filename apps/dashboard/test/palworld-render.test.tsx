...
test("Pal 도감 상세 필터는 서버 facet만 아이콘·텍스트 단일 선택으로 렌더한다", () => {
  ...
  assert.doesNotMatch(html, /palworld-pal-filter-work-icon/u);
  assert.doesNotMatch(html, /\/images\/palworld\/work\//u);
...
test("Pal 작업 적성 candidate 이미지는 공개하지 않고 접근 가능한 glyph·Lv. 숫자와 능력치 그래프를 표시한다", () => {
