export const dashboardI18n = {
  ko: {
    ...
    dashboard: {
      ...
      twitchStatusUnavailable: "Twitch 상태 확인 실패",
      twitchStatusError: "상태 오류",
      twitchConnectAction: "Twitch 연결",
      twitchReconnectAction: "OAuth 갱신",
      statusLabels: {
        server: "서버",
        twitch: "Twitch",
        stream: "방송",
  ...
  ja: {
    ...
    dashboard: {
      ...
      twitchOAuth: "OAuth",
      twitchEventSub: "EventSub",
      twitchStatusUnavailable: "Twitch 状態確認失敗",
      twitchStatusError: "状態エラー",
      twitchConnectAction: "Twitch 接続",
      twitchReconnectAction: "OAuth 更新",
      statusLabels: {
        server: "サーバー",
        twitch: "Twitch",
        stream: "配信",
